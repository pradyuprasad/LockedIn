...
class ActivityAnalyzer:
    ...
    def update_duration(self, app_name: str, window_title: Optional[str], url: Optional[str], duration: float) -> None:
    ...
    def calculate_top_activities(self, limit: int = 5) -> List[Tuple[str, float]]:
        ...
        return [(activity, (duration / total_time) * 100) for activity, duration in top_n]
