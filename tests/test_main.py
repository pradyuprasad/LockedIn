...
class TestUtilityFunctions(unittest.TestCase):
    ...
    def test_extract_domain(self):
        ...
        self.assertEqual(extract_domain("https://subdomain.example.com/path?query=1"), "subdomain.example.com")
...
class TestAppleScriptFunctions(unittest.TestCase):
    ...
    def test_run_applescript_success(self, mock_run):
        ...
        mock_run.assert_called_with(['osascript', '-e', 'test script'], 
...
class TestActivityTracking(unittest.TestCase):
    ...
    def test_get_active_window_info(self, mock_get_window_title, mock_get_browser_info, mock_workspace):
        ...
        # Test idle state
        mock_shared.activeApplication.return_value = {"NSApplicationName": "loginwindow"}
...
class TestActivityAnalysis(unittest.TestCase):
    ...
    def test_update_duration(self):
        ...
        self.analyzer.update_duration("Safari", "Example Page", "https://example.com", 60)
